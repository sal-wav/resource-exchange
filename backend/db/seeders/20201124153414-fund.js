  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('Funds', [
      { title: 'Community Fridges',
        ...
        goal: 500,
        funded: 300,
        image: 'https://images.unsplash.com/photo-1516594798947-e65505dbb29d?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1050&q=80',
        categoryId: 2,
        ownerId: 4,
        createdAt: new Date(),
        updatedAt: new Date()
