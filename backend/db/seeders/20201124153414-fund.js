  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('Funds', [
      ...
      { title: 'Funds Needed to Stay Warm',
        ...
        goal: 300,
        funded: 65,
        image: 'https://images.unsplash.com/photo-1547186577-a3f4fa07c2ef?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=967&q=80',
        categoryId: 1,
        ownerId: 6,
        createdAt: new Date(),
        updatedAt: new Date()
